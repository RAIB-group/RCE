...
Run:
    ...
    python prob2_test_set_same_pairs.py \
        ...
        --out-root output_submission/prob2_test_set_same_pairs \
...
To run everything (all datasets / all FR models found under `--fr-features-root`):
    ...
    python prob2_test_set_same_pairs.py --run-all --skip-evr-plot --skip-additional-plots
...
Outputs are written to:
    ...
    output_submission/prob2_test_set_same_pairs/{dataset_name}/{fr_model}/
"""
...
DEFAULT_OUT_ROOT = os.path.join("output_submission", "prob2_test_set_same_pairs")
...
if __name__ == "__main__":
    ...
    p.add_argument(
        ...
        help="Output root directory (default: output/prob2_test_set_same_pairs)",
    )
    p.add_argument(
        "--run-all",
        action="store_true",
